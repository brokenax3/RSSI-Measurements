# Bluetooth LE Scanning Module (Channel Modeling )(BEACON 1 ONLY)
...
deviceArray = empty([int(numScan)], dtype=arrtype)
...
while count < int(numScan):
    ...
    if rem != 1:
        print("\nFailed to obtain 1 readings... Repeating iteration : %d " % (count+1))
...
with open("channelmodel.csv", "ab") as f:
    savetxt(f,deviceArray,delimiter=",", fmt="%s")
